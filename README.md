...
4. Copy the [.mez file](https://github.com/kerski/powerquery-connector-pbi-rest-api-gcc/releases/download/v1.2.0-beta/powerquery-connector-pbi-rest-api-gcc.mez) to your folder "Documents\Power BI Desktop\Custom Connectors".  If the folder does not exist, create it first.
